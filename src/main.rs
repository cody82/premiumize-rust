...
fn main() -> Result<(), premiumize::PremiumizeError> {
    let matches = App::new("Premiumize downloader")
        ...
        .subcommand(
            SubCommand::with_name("mkdir").about("create a folder").arg(
                Arg::with_name("folder")
                    .index(1)
                    .required(true)
        ...
        .subcommand(
            SubCommand::with_name("id").about("get id").arg(
                Arg::with_name("folder")
                    .index(1)
                    .required(true)
                    .help("path"),
        ...
        .subcommand(
            SubCommand::with_name("list").about("list folder").arg(
                Arg::with_name("folder")
                    .index(1)
                    .required(true)
                    .help("path"),
        ...
        .subcommand(
            SubCommand::with_name("transfer-url")
        ...
        .subcommand(
            SubCommand::with_name("transfer-file")
